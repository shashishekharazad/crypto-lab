public class DESCipherJava {
    ...
    // final (inverse IP) permutation
    private static int[] FP = { 40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47,
...
String s = "1111101011011"; 
String str = s.substring(0, 6);
String rowS = s.substring(0, 1) + s.substring(5, 6);
String colS = str.substring(1, 5);
System.out.println(rowS +" "+ Integer.parseInt(rowS,2) + " " + colS + " "+Integer.parseInt(colS,2));
    }
}