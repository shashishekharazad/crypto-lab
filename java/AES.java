...
public class AES {
    ...
    private static char getSBoxValue(char num) {

        return 0;
    }

    private static char getSBoxInvert(char num) {

        return 0;
    }

    private void rotate(char[] word) {

    }

    private static char getRConValue(char num) {
        return 0;
    }

    private static void core(char[] word, int i) {

    }

    private static void expandKey(char[] expandedKey, char[] key, int size, int expandedKeySize) {
        ...
        while(currentSize < expandedKeySize){
            for(int i = 0; i < 4; i++){
                temp[i] = expandedKey[(currentSize - 4) + 1];
            }
            if(currentSize % size == 0){
                core(temp, rconIteration++);
            }
            for(int i = 0; i < 4; i++){
                expandedKey[currentSize] = (char)(expandedKey[currentSize - size] ^ temp[i]);
                currentSize++;
            }
        }
    ...
    private static void shiftRows(char[] state, char number) {
    ...
    private static char galoisMultiplication(char a, char b) {
        return 0;
    }
    ...
    private static void mixColumn(char[] state, char[] comuns) {
    ...
    private static void createRoundKey(char[] expandedKey, char[] roundKey) {

    }

    private static void aesMain(char[] state, String expandedKey, int roundNum) {
        char[] roundKey = new char[16];
        createRoundKey(expandedKey.substring(0, 16).toCharArray(), roundKey);
        addRoundKey(state, roundKey);

        for(int i = 1; i < roundNum; i++){
            createRoundKey(expandedKey.substring(i*16, (i*16)+16).toCharArray() , roundKey);
            aesRound(state, roundKey);
        }

    }

    private static char aesEncryption(char[] input, char[] output, char[] key, int keySize) {
        int roundNum = 10;
        int expandedKeySize = (16 * (roundNum + 1));
        char[] expandedKey = new char[expandedKeySize];
        ...
        aesMain(block, expandedKey, roundNum);
    ...
    private static void revSubBytes(char[] state) {

    }

    private static void revShiftRows(char[] state) {

    }

    private static void reShiftRow(char[] state, char number) {

    }

    private static void revMixColumns(char[] state) {

    }

    private static void revMixColumn(char[] state) {

    }

    private static void revAesRound(char[] state, char[] roundKey) {

    }

    private static void revAesMain(char[] state, char[] expandedKey, int roundNum) {

    }

    private static void aesDecryption(char[] input, char[] output, int keySize) {
    ...
    public static void main(String[] args) {
        ...
        char[] encipherText = new char[16];
        char[] decipherText = new char[16];
        char[] expandedKey = new char[expandedKeySize];

        expandKey(expandedKey, key, size, expandedKeySize);
        for (int i = 0; i < expandedKeySize; i++) {
            System.out.print(String.format("%h", expandedKey[i]) + " ");
            if (i % 16 == 0)
                System.out.println();
        }

        aesEncryption(plainText, encipherText, key, size);
