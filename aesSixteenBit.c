...
char encryptPlainTxt(unsigned char *input, unsigned char *output, unsigned char *key, enum keySize size);
...
int main()
{
    ...
    printf("Expanded round key for 10 rounds\n");
    for (i = 1; i < expandedKeySize; i++)
    {
    ...
    aes_decrypt(cipherText, decrText, key, SIZE);
